...
Route::middleware('auth:api')->get('/user', function (Request $request) {
    ...
    Route::group(['middleware' => ['jwt.verify']], function() {
        ...
        //Postulation
        Route::get('postulations','PostulationController@index');
        Route::get('postulations/{postulation}', 'PostulationController@show');
        Route::post('postulations', 'PostulationController@store');
        Route::put('postulations/{postulation}', 'PostulationController@update');
        Route::delete('postulations/{postulation}','PostulationController@delete');
        //Skill
